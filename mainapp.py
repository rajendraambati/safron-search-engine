...
# Only set up signal handlers if running in a local environment
if os.getenv("STREAMLIT_SERVER") is None:  # Check if not running on Streamlit Cloud
    import signal
    signal.signal(signal.SIGINT, signal_handler)
    signal.signal(signal.SIGTERM, signal_handler)
else:
    logging.warning("Signal handling is disabled in Streamlit Cloud.")
