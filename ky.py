...
def main():
    ...
    # Session state to track if scraping is completed and if results have been downloaded
    ...
    # Reset logic when a new search query is entered
    if search_query.strip() and not st.session_state.scraping_completed:
        st.session_state.scraping_completed = False
        st.session_state.download_clicked = False
    ...
    if not st.session_state.scraping_completed and scrap_button:
    ...
    # Re-enable the "Scrap It!" button after download starts
